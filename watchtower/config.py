...
def init_app(app):
    ...
    For testing, set os.environ['CONFIG'] to 'watchtower.config.TestConfig' before calling create_app.
    '''

    # First load the default values
    app.config.from_object('watchtower.config.Config')
